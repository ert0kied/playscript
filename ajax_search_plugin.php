    ...
    if(isset($_POST["searchitem"]) && $_POST["searchitem"] != ""){
        ...
        if($found){
            ...
            foreach ($result as $item) {
                ...
                print "<div class='pack_block'>";
                print "<div class='pack_name'><a href='" . $h . "' target='_blank' title='Homepage of " . $n . "'>" . $n . "</a></div>";
                print "<div class='pack_input_link'><input onClick='this.select()' class='reset-this' type='text' value='" . $l . "'></div>";
                print "<div class='pack_description'>" . $d . "</div>";
                print "</div>";
            }

        } else {
            print "No library/package/plugins was found!";
        }
    } else {
