...
<div class="modal fade" id="sharemodel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content sharebody">
		...
		<div class="d">
			<?php print $logo ?> has is developed by <a href="https://twitter.com/rakibtg" target="_blank">Hasan</a>, if you like this software then please join at GitHub and contribute your beautiful code!
		</div>
		
		<div class="t">Version / Update</div>
		<div class="d">
			<b>Current Version:</b> v5.0
