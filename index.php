    ...
    <div class="output codeot">
        <?php 
            if (isset($filename)) {
                ...
                print "<iframe src=\"$filename\" frameborder=\"0\" width=\"100%\" height=\"100%\"></iframe>";
            } else {
    ...
    <div class="output">
        <div class="editorwrapper">
            <form action="index.php" method="POST">
                ...
                <span class="ProjectRenameBeforeExecute"> Project Name: <input class="SetFileName" title="Click to rename" type="text" name="SetFileName" value="<?php print $DynamicName; ?>"></span>
                <span class="overwriteProject"><i class="fa fa-retweet"></i> Overwrite</span>
            </form>
        </div>
    </div>
</div>
